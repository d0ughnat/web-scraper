...
import VideoOverlayApp from './tools/OverLay';
import './App.css';
        ...
        <main className="app-content">
          <div className="content-wrapper">
            ...
            <div className="tab-navigation">
              ...
              <button
                className={`tab-button ${activeTab === 'videooverlay' ? 'active' : ''}`}
                onClick={() => handleTabChange('videooverlay')}
              >
                Video Overlay
              </button>
            </div>
            ...
            <section className="tab-content">
              ...
              {activeTab === 'videooverlay' && (
                <div className="video-overlay-section">
                  <h2>Video Overlay Tool</h2>
                  <VideoOverlayApp />
                </div>
              )}
            </section>
